  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Eleave Data</h1>
          </div><!-- /.col -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Edit Eleave Data </h4>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <BR>  
                    ...
                    <form action="<?=site_url('eleave/update_data_edit_order')?>" method="post" enctype="multipart/form-data" >
                        ...
                        <BR>
                            ...
                            <div class="col-sm-1">
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>ชื่อ</label>
                                    <input type="text" id="form_eleave_name"class="form-control" name="form_eleave_name"value="<?php echo $eleave_name; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>นามสกุล</label>
                                    <input type="text" id="form_eleave_surname"class="form-control" name="form_eleave_surname"value="<?php echo $eleave_surname; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>Email</label>
                                    <input type="text"  id="form_eleave_email"name="form_eleave_email"class="form-control" required value="<?php echo $eleave_mail; ?> "readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>สังกัด</label>
                                    <input type="text"  id="form_eleave_company_name"name="form_eleave_company_name"class="form-control" required value="<?php echo $eleave_company_name; ?> "readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>ฝ่าย</label>
                                    <input type="text" id="form_eleave_department" name="form_eleave_department" class=" form-control" value="<?php echo $eleave_department; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    <label>ตำแหน่ง</label>
                                    <input type="text" id="form_eleave_job_position"name="form_eleave_job_position" class="form-control" value="<?php echo $eleave_job_position; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_phone" name="form_eleave_phone"class="form-control" value="<?php echo $eleave_phone; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_range_time" name="form_eleave_range_time"class="form-control"value="<?php echo $eleave_range_time_name ; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="date"id="form_eleave_date_start" name="form_eleave_date_start"class="form-control"value="<?php echo $eleave_date_start; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="time" id="form_eleave_time_start" name="form_eleave_time_start"class="form-control"value="<?php echo $eleave_time_start; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="date" id="form_eleave_date_end"  name="form_eleave_date_end"class="form-control"value="<?php echo $eleave_date_end ; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="time" id="form_eleave_time_end" name="form_eleave_time_end"class="form-control"value="<?php echo $eleave_time_end ; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_number_time_eleave" name="form_eleave_number_time_eleave"class="form-control"value="<?php echo $eleave_number ; ?>"readonly>
                                    <p id="number"></p>
                                  </div>
                                </div>
                                            <!--  -->
                                    <div class="col-sm-12">
                                      <div class="form-group">
                                          <label>สาเหตุที่ลา</label>
                                              <textarea id="form_eleave_cause" name="form_eleave_cause" class="form-control" rows="3"placeholder="กรุณากรอกเหตุผลที่ลา"readonly><?php echo $eleave_cause ; ?></textarea>
                                      </div>
                                    </div>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_address_eleave" name="form_eleave_address_eleave"class="form-control" value="<?php echo $eleave_address_eleave; ?>">
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_manager_approve" name="form_eleave_manager_approve"class="form-control" value="<?php echo $eleave_manager_approve_id_default; ?>"readonly>
                                ...
                                <!-- text input -->
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="form_eleave_humane_resources_approve"name="form_eleave_humane_resources_approve"class="form-control" name="from_humane_resources_approve" value="<?php echo $eleave_humane_resources_id_default; ?>"readonly>
