...
<head>
  ...
  <title>View Eleave Manager Approve </title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Eleave Manager Approve   </h1>
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  ผู้จัดการโปรดตรวจสอบข้อมูลการลาเพื่ออนุมัติการลางาน
                </h3>
              </div>
                     ...
                     <!-- <?php }?> -->
                      ...
                      <div class="row">
                          <div class="col-sm-3">
                                    ...
                                    <a href="<?= site_url(); ?>/eleave/eleave_load_view_export_manager_excel"><button class="form-control" type='submit' ><font color ="#FFFFFF"> Export Excel Manager Oder</font></button></a>
  ...
  <script type="text/javascript"> 
    ...
    $(document).ready(function(){
          ...
          "createdRow": function( row, data, dataIndex ) {
	      	...
	      	ajax: {
	          url:'<?php echo site_url('eleave/eleave_manager_approve_load_data_content'); ?>',
	          data: function(data){
            ...
            { data: 'ELEAVE_ID',
                          render: function (data,type,row){
                            var view = '<a href="<?php echo site_url() ?>/eleave/eleave_view_edit_status_manager_approve/' + data + '" ><center><img src="<?php echo base_url('img') ?>/Allimg/icon_check.png" > </center></a>';
                                    return view;
                                  } },
