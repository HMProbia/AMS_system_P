...
<head>
  ...
  <title>View Helpdesk Data Status</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">View Helpdesk Data Status</h1>
              ...
              <form action="<?php echo base_url('index.php/eleave/export_eleave_data_excel'); ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="col-sm-2">
                    ...
                    <!-- /2 -->
                      ...
                      <div class="col-sm-2">
                                <div class="form-group"><BR>
                                <button class="form-control"><a href="<?= site_url(); ?>/helpdesk/help_add_case" ><font color ="#FFFFFF">เปิดเคส</font></a></button>
                      ...
                      <table id="helpdesk_status_list" class=" table   table-bordered    " width ="100%" >
                        ...
                        <thead>
                            <tr>
                              ...
                              <!-- <th bgcolor="#000000"width="60" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">รหัสใบงาน</font></th>
                              <th bgcolor="#000000"width="60" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">ประเภท</font></th>
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">วันที่ส่งคำขอ</font></th>
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">จากแผนก</font></th>
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">ชื่อผู้ส่ง</font></th>
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">หัวข้อ</font></th>
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">ผู้รับงาน</font></th>
                              <th bgcolor="#000000"width="70" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">ตรวจสอบข้อมูล</font></th>
                              <th bgcolor="#000000"width="70" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">สถานะใบงาน</font></th> -->
  ...
  <script type="text/javascript"> 
    ...
    $(document).ready(function(){
          ...
          "createdRow": function( row, data, dataIndex ) {
	      	...
	      	ajax: {
	          url:'<?php echo site_url('helpdesk/ajax_search_data_status_cases'); ?>',
	          data: function(data){
              ...
              { data: 'HELPDESK_S_ID',
                          render: function (data,type,row){
                            var view = '<a href="<?php echo site_url() ?>/helpdesk/helpdesk_view_checking_case/' + data + '" ><center><img src="<?php echo base_url('img') ?>/Allimg/icon_check.png" > </center></a>';
                                    return view;
                                  }},
	   	...
	   	$('#form_helpdesk_s_id,#form_helpdesk_type_id,#form_date_to_send,#form_company_name').change(function(){
	   		userDataTable.draw();
	   	});
