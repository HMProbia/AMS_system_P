...
<head>
  ...
  <title>เพิ่มข้อมูลผู้อนุมัติของฝ่ายบุคคล</title>
</head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add HR Approve   </h1>
                   ...
                   <div class="col-sm-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2bs4"  name ="user_department" id="user_department" style="width: 100%;">
                            <option selected="selected" value="03Human Resources">03Human Resources</option>
                    ...
                    <table id="account_list" class=" table   table-bordered    " width ="100%" >
                        ...
                        <thead>
                            <tr>
                              ...
                              <th bgcolor="#000000"width="80" style="margin: 3px; padding: 3px; text-align: center"><font color ="#FFFFFF">เพิ่มข้อมูล</font></th>
  ...
  <!-- /.content-wrapper -->
    ...
    $(document).ready(function(){
          ...
          "createdRow": function( row, data, dataIndex ) {
	      	...
	      	ajax: {
	          url:'<?php echo site_url('account/account_load_view_add_hrcontent'); ?>',
	          data: function(data){
	      	...
	      	'columns': [
	         	{
                       ...
                       render: function (data,type,row){
...

                        {
                          data:'USER_ID',
                          render: function (data,type,row){
                            var view = '<a href="<?php echo site_url() ?>/account/view_data_hr_add_approve/' + data + '" ><center><img src="<?php echo base_url('img') ?>/Allimg/icon_check.png" > </center></a>';
                                    return view;
                                  }
